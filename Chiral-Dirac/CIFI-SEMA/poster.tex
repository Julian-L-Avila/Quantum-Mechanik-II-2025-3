  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=south] at ([yshift=3.5cm]current page.south) {
        \makebox[0.9\paperwidth][c]{
          ...
          \includegraphics[height=9cm]{./figures/ud-chapter-vertical.pdf}\hfill
          \includegraphics[height=6cm]{./figures/acolfisica.pdf}\hfill
          \includegraphics[height=7cm]{./figures/cifi-sema.pdf}
        }
      };
  \end{tikzpicture}
}
...
\begin{frame}[t]
  ...
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \input{./sections/chirality.tex}

      \input{./sections/qde.tex}

      \input{./sections/yukawa.tex}
    \end{column}
    \begin{column}{0.48\textwidth}
      \input{./sections/zero-mass.tex}
